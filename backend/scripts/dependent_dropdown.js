...
const subcategories = {
    //COMPENSATION
    "COMPENSATION": ["1.1 Compulsory Purchase", "1.2 Land Compensation Act 1973 Part I", "1.3 Mining subsidence",
...
//RATING
    "RATING": ["2.1 Valuation", "2.2 Exemption", "2.3 Alteration of rating list", "2.4 Comparables", "2.5 Hereditament",
...
//RESTRICTIVE COVENANTS
    "RESTRICTIVE COVENANTS": ["3.1 Discharge", "3.2 Modification", "3.3 Obsoleteness", "3.4 Practical benefits of substantial value or advantage", 
...
//LEASEHOLD ENFRANCHISEMENT
    "LEASEHOLD ENFRANCHISEMENT": ["4.1 Collective enfranchisement", "4.2 House", "4.3 Flat", "4.4 Price", "4.5 Premium", "4.6 Comparables",
...
//LANDLORD AND TENANT
    "LANDLORD AND TENANT": ["5.1 Service Charges", "5.2 Insurance", "5.3 Appointment of manager", "5.4 Right to manage",
...
//BLIGHT NOTICE
    "BLIGHT NOTICE": ["6.1 Blight notice", "6.2 Preliminary Issue"],
    
//TAX
    "TAX": ["7.1 Inheritance tax", "7.2 Capital gains tax", "7.3 Comparables", "7.4 House",
"7.5 Hotel", "7.6 Procedure", "7.7 Costs"],
    
//EASEMENT
    "EASEMENT": ["8.1 Countryside and Right of Way Act 2000"],
    
//ARBITRATION
    "ARBITRATION": ["9.1 Access rights"],
    
//COSTS
    "COSTS": ["10.1 Preliminary issues", "10.2 Preliminary issues ", "10.3 Right to Manage"],
    
//HOUSING
    "HOUSING": ["16.1 Emergency remedial action", "16.2 Prohibition Notice", "16.3 Enforcement action",],
    
//PARK HOMES
    "PARK HOMES": ["19.1 Administration Charges", "19.2 Pitch Fee Review", "19.3 Sale, assignment and succession",
"19.4 Site Rules", "19.5 Procedure", "19.6 Water Charges", "19.7 Site Licencing", "19.8 Jurisdiction", "19.9 Electricity Charges"],
    
//LAND REGISTRATION
    "LAND REGISTRATION": ["25.1 Unilateral notice", "25.2 Adverse possession", "25.3 Alteration and rectification",
...
//ELECTRONIC COMMUNICATIONS CODE
    "ELECTRONIC COMMUNICATIONS CODE": ["26.1 Jurisdiction", "26.2 Interim Code Rights", "26.3 Code rights", "26.4 Temporary Code rights",
"26.5 Consideration", "26.6 Compensation", "26.7 Other", "26.8 New agreement or modification"],

//INTERIM RIGHTS
//No subcategories for this category
    "INTERIM RIGHTS": ["No subcategories"],

//ELECTRICITY CHARGES
//No subcategories for this category
    "ELECTRICITY CHARGES": ["No subcategories"],
//BUILDING SAFETY
    "BUILDING SAFETY": ["29.1 REMEDIATION CONTRIBUTION ORDER", "29.2 Accountable Person", "29.3 LEASEHOLDER PROTECTION"],
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    categorySelect.addEventListener('change', function() {
        ...
        options.forEach(function(sub) {
            ...
            // Strip off leading number + dot for the value
            const cleanValue = sub.replace(/^\d+\.\d+\s*/, "");
            option.value = cleanValue;        // backend receives plain text
            option.textContent = sub;         // user sees numbered label
